...
import com.testwithspring.master.message.MessageApplication
...
@SpringBootTest(classes = SpockendtoendtestApplication.class, webEnvironment = WebEnvironment.RANDOM_PORT)
